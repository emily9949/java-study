package com.sumin.section03.uses;
...
public class Application1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println(new File("test.dat").getAbsolutePath()); // 파일 객체 생성

        BufferedReader br = null;

        /* 설명. 경로를 계속 생성해주는 것 */
        /* 설명. FileReader() 를 사용하려면 throws 예외처리도 해주어야함 */
        try {
            ...
            /* 설명. 예외처리 구문과 상관없이 반드시 수행해야 하는 경우 finally에 작성하는데
            ...
            * */
            try {
                ...
                if (br != null)
                    ...
                    /* 설명. 입출력에서 사용한 스트림(통로)를 닫아주는 용도의 메소드이다.
                     *   스트림이 없을 때 (null)를 고려하고 IOException을 처리해야 제대로 쓸 수 있다.
                     * */
                    br.close(); // br이 가리키는 객체가 있을 때만 닫아준다
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
        }
