...
public class Application2 {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("delete(): " + sb.delete(2, 5)); // 문자열과 (+) stringbuilder -> toString을 알아서 해줌
        System.out.println("deleteCharAt(): " + sb.deleteCharAt(2)); // String으로 charAt + delete를 하려면 알고리즘을 구현해야함.
