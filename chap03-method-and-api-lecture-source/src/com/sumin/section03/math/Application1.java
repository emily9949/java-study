...
public class Application1 {
  ...
  //      double result = java.lang.Math.abs(-32.1);
         ...
         /* 설명. 다른 패키지에 있는 api 클래스는 import 또는 풀 클래스명을 써야 되지만 java.lang 은 생략 가능 */
         double result = Math.abs(-32.1);                       // abs 함수 : 절대값
        System.out.println("result = " + result);

        /* 설명. 최대값, 최소값 출력 */
        System.out.println("10 과 20 중 더 작은 것은 " + Math.min(10, 20));
